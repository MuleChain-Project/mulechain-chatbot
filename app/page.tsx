...
const examples = [
  ...
  "Order a new laptop from your asset portal for Amir Khan",
  "Retrieve all accounts from Salesforce CRM",
];
        ...
        <div className="mx-5 mt-20 max-w-screen-md rounded-md border border-gray-200 sm:mx-0 sm:w-full">
          <div className="flex flex-col items-center p-5 sm:flex-row sm:p-10">
            <Image
              ...
              className="mb-4 h-12 w-12 sm:mb-0 sm:mr-10 sm:h-16 sm:w-16" // Responsive size adjustments and margin
            />
            <div className="flex flex-col space-y-2 text-center sm:text-left">
              <h1 className="text-lg font-semibold text-black sm:text-xl">
                Welcome to the MuleChain AI Agent
              </h1>
